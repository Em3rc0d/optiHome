...
const testimonials = [
  ...
  {
    name: "María P.",
    text: "Tenía molestias visuales y con la revisión de OptiHome encontré mi medida correcta. Luego validé el resultado y coincidió perfectamente.",
  },
  {
    name: "Jorge C.",
...
export const TestimonialsCarousel = () => {
  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white via-green-50/40 to-blue-50/40 border-t border-gray-100">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-4xl font-extrabold text-gray-900 mb-4">
          Lo que opinan nuestros clientes
        </h2>
        <p className="text-lg text-gray-700 mb-12 max-w-2xl mx-auto">
          En <span className="text-green-600 font-semibold">OptiHome</span>{" "}
        ...
        <motion.blockquote
          ...
          className="relative bg-white p-10 rounded-2xl shadow-xl border border-blue-100 max-w-3xl mx-auto"
        >
