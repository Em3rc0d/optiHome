      ...
      <div className="content-shell section-pad grid items-center gap-10 lg:grid-cols-2">
        ...
        <div>
          ...
          <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:items-center">
            <Link href="/products?tryon=1#prueba-virtual" {...intentProps("cta_path_virtual_try_on")} className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-brand px-6 py-3 font-semibold text-white hover:bg-brand-strong">
