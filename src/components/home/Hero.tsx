  ...
  return (
    <section className="overflow-hidden bg-white">
      <div className="content-shell grid min-h-[calc(100svh-4rem)] items-center gap-12 py-12 lg:grid-cols-[1.05fr_.95fr] lg:py-16">
        <div>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <Link
              ...
              className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-brand px-6 py-3 font-semibold text-white transition-colors hover:bg-brand-strong"
            >
            ...
            <Link
              ...
              className="inline-flex min-h-12 items-center justify-center rounded-xl border border-border bg-white px-6 py-3 font-semibold text-ink transition-colors hover:border-brand hover:text-brand"
            >
              Explorar monturas
            </Link>
          </div>
        ...
        <div className="relative mx-auto aspect-[4/5] w-full max-w-xl overflow-hidden rounded-3xl border border-border bg-surface-soft">
          <Image
            src="/exam-home.png"
